...
object DnsPoolScanner {
    ...
    suspend fun scan(
        ...
        val resultChannel = kotlinx.coroutines.channels.Channel<Pair<PoolEntry, com.vpntz.app.domain.model.E2eTestResult>>(
            kotlinx.coroutines.channels.Channel.UNLIMITED
        )
                        ...
                        launch {
                            val ok = phase1Sem.withPermit {
                                scanner.isResolverAlive(
                                    ...
                                    transport = com.vpntz.app.domain.model.DnsTransport.UDP,
                                )
                            }
        ...
        val collected = mutableListOf<Pair<PoolEntry, com.vpntz.app.domain.model.E2eTestResult>>()
        var earlyExit = false
        try {
