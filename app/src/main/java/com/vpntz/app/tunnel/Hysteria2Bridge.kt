...
object Hysteria2Bridge {
    ...
    fun start(
        ...
        com.vpntz.app.util.AppLog.i(TAG, "Starting Hysteria2 bridge on $listenHost:$listenPort " +
        ...
        return try {
            ...
            client = c
            running.set(true)
            com.vpntz.app.util.AppLog.i(TAG, "Hysteria2 bridge started")
            Result.success(Unit)
        } catch (e: Exception) {
            com.vpntz.app.util.AppLog.e(TAG, "Failed to start Hysteria2 bridge: ${e.message}", e)
            stop()
            Result.failure(e)
        }
    }
