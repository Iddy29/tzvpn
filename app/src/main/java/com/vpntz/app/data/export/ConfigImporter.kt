package com.vpntz.app.data.export
...
import com.vpntz.app.util.BundleCrypto
 ...
 *
 * Expected format: vpntz://[base64-encoded-profile]
...
class ConfigImporter @Inject constructor() {
    ...
    companion object {
        private const val SCHEME = "vpntz://"
        private const val ENCRYPTED_SCHEME = "vpntz-enc://"
        private const val BUNDLE_ENCRYPTED_SCHEME = "vpntz-bundle-enc://"
    ...
    fun parseAndImport(
        ...
        // Accept legacy "tzvpn://" scheme family for backwards compatibility
        val legacyNormalized = input
            .replace("tzvpn-bundle-enc://", BUNDLE_ENCRYPTED_SCHEME, ignoreCase = true)
            .replace("tzvpn-enc://", ENCRYPTED_SCHEME, ignoreCase = true)
            .replace("tzvpn://", SCHEME, ignoreCase = true)
        val trimmedInput = legacyNormalized.trim()
