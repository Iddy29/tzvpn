 ...
 *
 * Single profile format: vpntz://[base64-encoded-profile]
...
class ConfigExporter @Inject constructor() {
    ...
    companion object {
        const val SCHEME = "vpntz://"
        const val ENCRYPTED_SCHEME = "vpntz-enc://"
        /** Scheme for password-encrypted multi-profile bundles (see [exportAllProfilesEncrypted]). */
        const val BUNDLE_ENCRYPTED_SCHEME = "vpntz-bundle-enc://"
