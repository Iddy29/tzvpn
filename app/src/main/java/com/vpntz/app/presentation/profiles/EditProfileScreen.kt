package com.vpntz.app.presentation.profiles
...
import com.vpntz.app.tunnel.DOH_SERVERS
import com.vpntz.app.tunnel.DohServer
            ...
            Column(
                ...
                Surface(
                    onClick = {
                        val intent = android.content.Intent(
                            android.content.Intent.ACTION_VIEW,
                            android.net.Uri.parse("https://github.com/vpntz/vpn-tz/tzgate")
                        )
                        context.startActivity(intent)
                    },
                    shape = RoundedCornerShape(12.dp),
