...
import com.vpntz.app.data.local.datastore.SshCipher
import com.vpntz.app.tunnel.DomainRouter
import com.vpntz.app.tunnel.GeoBypassCountry
import com.vpntz.app.tunnel.GeoBypassData
...
import com.vpntz.app.domain.model.isAvailable
...
import com.vpntz.app.tunnel.DnsttSocksBridge
import com.vpntz.app.tunnel.VaydnsBridge
import com.vpntz.app.tunnel.DohBridge
import com.vpntz.app.tunnel.HevSocks5Tunnel
import com.vpntz.app.tunnel.HttpProxyServer
import com.vpntz.app.tunnel.NaiveBridge
import com.vpntz.app.tunnel.NaiveSocksBridge
import com.vpntz.app.tunnel.RateLimiter
import com.vpntz.app.tunnel.SlipstreamBridge
import com.vpntz.app.tunnel.SlipstreamSocksBridge
import com.vpntz.app.tunnel.Socks5ProxyBridge
...
import com.vpntz.app.tunnel.TorSocksBridge
...
@AndroidEntryPoint
class VpnTzService : VpnService() {

    companion object {
        private const val TAG = "VpnTzService"
        const val ACTION_CONNECT = "com.vpntz.app.CONNECT"
        const val ACTION_DISCONNECT = "com.vpntz.app.DISCONNECT"
        const val ACTION_RECONNECT = "com.vpntz.app.RECONNECT"
    ...
    @Inject
    lateinit var chainRepository: com.vpntz.app.domain.repository.ChainRepository
    ...
    private fun connect(profileId: Long) {
        ...
        connectJob = serviceScope.launch {
            ...
            com.vpntz.app.util.AppLog.redactSensitive = profile.isLocked
            ...
            if (wakeLock == null) {
                wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "VPN-TZ:VpnWakeLock").apply {
            ...
            if (wifiLock == null) {
                ...
                wifiLock = wifiManager?.createWifiLock(wifiMode, "VPN-TZ:VpnWifiLock")?.apply {
                    setReferenceCounted(false)
                    acquire()
                }
            ...
            try {
                ...
                val globalResolverOverride: List<com.vpntz.app.domain.model.DnsResolver>? =
    ...
    private fun connectChain(chainId: Long) {
        ...
        connectJob = serviceScope.launch {
            ...
            // Validate the chain
            val validationError = com.vpntz.app.domain.model.ChainValidation.validate(profiles)
            ...
            com.vpntz.app.util.AppLog.redactSensitive = profiles.any { it.isLocked }
            ...
            if (wakeLock == null) {
                wakeLock = pm.newWakeLock(android.os.PowerManager.PARTIAL_WAKE_LOCK, "VPN-TZ:VpnWakeLock").apply {
                    setReferenceCounted(false)
                    acquire(WAKELOCK_TIMEOUT_MS)
                }
            }
     ...
     */
    private suspend fun executeChain(profiles: List<com.vpntz.app.domain.model.ServerProfile>) {
        ...
        val needsVpnFirst = com.vpntz.app.domain.model.ChainValidation.needsVpnFirst(outermost.tunnelType)
    ...
    private suspend fun startChainLayer(
        profile: com.vpntz.app.domain.model.ServerProfile,
        layerIndex: Int = 0,
        layerPort: Int,
        layerHost: String,
        prevPort: Int,
        ...
        prevProfile: com.vpntz.app.domain.model.ServerProfile? = null,
        isLast: Boolean,
        remoteDns: String,
        ...
        return when (profile.tunnelType) {
            TunnelType.DNSTT, TunnelType.NOIZDNS -> {
                DnsttBridge.setVpnService(this@VpnTzService)
                ...
                if (prevPort > 0 && prevLayerType != null && prevLayerType != TunnelType.SSH) {
                    val prevOutput = com.vpntz.app.domain.model.ChainValidation.outputType(prevLayerType)
                    if (prevOutput == com.vpntz.app.domain.model.LayerOutput.SOCKS5) {
            ...
            TunnelType.SLIPSTREAM -> {
                SlipstreamBridge.setVpnService(this@VpnTzService)
                if (isLast) {
                    val internalPort = internalPortBase
            ...
            TunnelType.SSH -> {
                ...
                if (prevPort > 0) {
                    ...
                    val output = com.vpntz.app.domain.model.ChainValidation.outputType(resolvedPrevType)
                    ...
                    withContext(Dispatchers.IO) {
                        when (output) {
                            com.vpntz.app.domain.model.LayerOutput.RAW_TCP -> {
                            ...
                            com.vpntz.app.domain.model.LayerOutput.SOCKS5 -> {
            ...
            TunnelType.SNOWFLAKE -> {
                ...
                val upstream = if (prevPort > 0 && prevLayerType != null &&
                    com.vpntz.app.domain.model.ChainValidation.outputType(prevLayerType) ==
                    com.vpntz.app.domain.model.LayerOutput.SOCKS5
                ) {
     ...
     */
    private suspend fun connectSlipstream(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String, remoteDns: String, remoteDnsFallback: String, globalResolverOverride: List<com.vpntz.app.domain.model.DnsResolver>? = null) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
    ...
    private suspend fun configureSshInstance(instance: com.vpntz.app.tunnel.SshTunnelInstance) {
        val cipher = preferencesDataStore.sshCipher.first()
        val compression = preferencesDataStore.sshCompression.first()
        val isCustom = preferencesDataStore.sshMaxChannelsIsCustom.first()
    ...
    private suspend fun connectSlipstreamSsh(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String, remoteDns: String, remoteDnsFallback: String, globalResolverOverride: List<com.vpntz.app.domain.model.DnsResolver>? = null) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
        val slipstreamPort = proxyPort + 1
     ...
     */
    private suspend fun connectDnstt(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String, remoteDns: String, remoteDnsFallback: String, globalResolverOverride: List<com.vpntz.app.domain.model.DnsResolver>? = null) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
     ...
     */
    private suspend fun connectSsh(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String, remoteDns: String, remoteDnsFallback: String, globalDnsIp: String? = null) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
     ...
     */
    private suspend fun connectNaiveSsh(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String, remoteDns: String, remoteDnsFallback: String) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
     ...
     */
    private suspend fun connectNaive(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String, remoteDns: String, remoteDnsFallback: String) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
        val naivePort = proxyPort + 1
     ...
     */
    private suspend fun connectDnsttSsh(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String, remoteDns: String, remoteDnsFallback: String, globalResolverOverride: List<com.vpntz.app.domain.model.DnsResolver>? = null) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
        val dnsttPort = proxyPort + 1
     ...
     */
    private suspend fun connectVaydns(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String, remoteDns: String, remoteDnsFallback: String, globalResolverOverride: List<com.vpntz.app.domain.model.DnsResolver>? = null) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
     ...
     */
    private suspend fun connectVaydnsSsh(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String, remoteDns: String, remoteDnsFallback: String, globalResolverOverride: List<com.vpntz.app.domain.model.DnsResolver>? = null) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
        val vaydnsPort = proxyPort + 1
     ...
     */
    private suspend fun connectDoh(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
     ...
     */
    private suspend fun connectSnowflake(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String) {
     ...
     */
    private suspend fun connectSocks5(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String, remoteDns: String) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
     ...
     */
    private suspend fun connectVless(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
        vpnRepository.setCurrentTunnelType(com.vpntz.app.domain.model.TunnelType.VLESS)
     ...
     */
    private suspend fun connectVlessReality(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
     ...
     */
    private suspend fun connectHysteria2(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
        vpnRepository.setCurrentTunnelType(com.vpntz.app.domain.model.TunnelType.HYSTERIA2)
    ...
    private suspend fun connectSnowflakeSmart(profile: com.vpntz.app.domain.model.ServerProfile, dnsServer: String) {
        val proxyPort = preferencesDataStore.proxyListenPort.first()
        val proxyHost = preferencesDataStore.proxyListenAddress.first()
        val torSocksPort = proxyPort + 1
        val snowflakePtPort = proxyPort + 2
        ...
        val transports = listOf(
            ...
            SmartTransport("obfs4", com.vpntz.app.presentation.profiles.EditProfileViewModel.DEFAULT_OBFS4_BRIDGES, 60000),
            SmartTransport("Meek Azure", com.vpntz.app.presentation.profiles.EditProfileViewModel.DEFAULT_MEEK_BRIDGE, 60000),
    ...
    private suspend fun cleanupConnection() {
        com.vpntz.app.util.AppLog.redactSensitive = false
    ...
    override fun onTaskRemoved(rootIntent: Intent?) {
        ...
        if (currentProfileId != -1L) {
            ...
            val restartIntent = Intent(this, VpnTzService::class.java).apply {
