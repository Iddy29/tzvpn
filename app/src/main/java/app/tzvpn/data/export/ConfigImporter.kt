...
import app.tzvpn.util.BundleCrypto
 ...
 *
 * Expected format: tzvpn://[base64-encoded-profile]
...
class ConfigImporter @Inject constructor() {
    ...
    companion object {
        private const val SCHEME = "tzvpn://"
        private const val ENCRYPTED_SCHEME = "tzvpn-enc://"
        private const val BUNDLE_ENCRYPTED_SCHEME = "tzvpn-bundle-enc://"
