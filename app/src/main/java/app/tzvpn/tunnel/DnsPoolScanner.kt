...
object DnsPoolScanner {
    ...
    suspend fun scan(
        ...
        val resultChannel = kotlinx.coroutines.channels.Channel<Pair<PoolEntry, app.tzvpn.domain.model.E2eTestResult>>(
            kotlinx.coroutines.channels.Channel.UNLIMITED
        )
                        ...
                        launch {
                            val ok = phase1Sem.withPermit {
                                scanner.isResolverAlive(
                                    ...
                                    transport = app.tzvpn.domain.model.DnsTransport.UDP,
                                )
                            }
        ...
        val collected = mutableListOf<Pair<PoolEntry, app.tzvpn.domain.model.E2eTestResult>>()
        var earlyExit = false
        try {
