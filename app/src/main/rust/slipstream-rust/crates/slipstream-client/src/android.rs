...
#[no_mangle]
pub extern "system" fn Java_com_vpntz_app_tunnel_SlipstreamBridge_nativeStartSlipstreamClient<'local>(
...
fn start_client_impl<'local>(
    ...
    if BRIDGE_CLASS.get().is_none() {
        let class_name = "com/vpntz/app/tunnel/SlipstreamBridge";
...
#[no_mangle]
pub extern "system" fn Java_com_vpntz_app_tunnel_SlipstreamBridge_nativeStopSlipstreamClient(
    _env: JNIEnv,
    _class: JClass,
) {
...
#[no_mangle]
pub extern "system" fn Java_com_vpntz_app_tunnel_SlipstreamBridge_nativeIsClientRunning(
    _env: JNIEnv,
    _class: JClass,
) -> jboolean {
    if IS_RUNNING.load(Ordering::SeqCst) {
...
#[no_mangle]
pub extern "system" fn Java_com_vpntz_app_tunnel_SlipstreamBridge_nativeIsQuicReady(
    _env: JNIEnv,
    _class: JClass,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_com_vpntz_app_tunnel_SlipstreamBridge_nativeGetLastError<'local>(
    env: JNIEnv<'local>,
    _class: JClass<'local>,
) -> jni::sys::jstring {
...
#[no_mangle]
pub extern "system" fn Java_com_vpntz_app_util_LockPasswordUtil_nativeGetConfigKey<'local>(
    env: JNIEnv<'local>,
    _class: JClass<'local>,
) -> jni::sys::jbyteArray {
