...
Java_app_tzvpn_tunnel_NativeSocket_nativeSetIpTtl(
 ...
 */
JNIEXPORT jint JNICALL
Java_app_tzvpn_tunnel_NativeSocket_nativeSetTcpMaxSeg(
 ...
 */
JNIEXPORT jint JNICALL
Java_app_tzvpn_tunnel_NativeSocket_nativeSendFakeThenSwap(
