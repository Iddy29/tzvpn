...
Java_com_vpntz_app_tunnel_NativeSocket_nativeSetIpTtl(
 ...
 */
JNIEXPORT jint JNICALL
Java_com_vpntz_app_tunnel_NativeSocket_nativeSetTcpMaxSeg(
 ...
 */
JNIEXPORT jint JNICALL
Java_com_vpntz_app_tunnel_NativeSocket_nativeSendFakeThenSwap(
