...
import "github.com/vpntz/vpn-tz/tzgate/internal/config"

// v17 field positions (pipe-delimited, 38 fields).
// Matches the VPN-TZ Android app's ConfigImporter/ConfigExporter.
const (
	FVersion            = 0  // "17"
...
// TunnelTypeMap maps transport+clientMode+backend to vpntz:// field[1] value.
...
// GetTunnelType returns the vpntz:// type string.
