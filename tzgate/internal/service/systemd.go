...
// ListTzgateServices returns the names of all tzgate-* service files
// found in the systemd directory (without the .service suffix).
func ListTzgateServices() []string {
	...
	for _, e := range entries {
		name := e.Name()
		if strings.HasPrefix(name, "tzgate-") && strings.HasSuffix(name, ".service") {
