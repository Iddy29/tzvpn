...
# to reach this TzGate server's DNS-tunneling transports (DNSTT / VayDNS).
#
# Usage:
...
#   - Excludes 127.0.0.0/8 (tzgate-dnsrouter -> local tunnel backends).
...
DEFAULT_LOG="/var/log/tzgate-dns-clients.log"
