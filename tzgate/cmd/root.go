...
import (
	...
	"github.com/vpntz/vpn-tz/tzgate/internal/handlers"
	"github.com/vpntz/vpn-tz/tzgate/internal/menu"
	"github.com/vpntz/vpn-tz/tzgate/internal/version"
	"github.com/spf13/cobra"

	// Register all actions
	_ "github.com/vpntz/vpn-tz/tzgate/internal/actions"
)

var rootCmd = &cobra.Command{
	Use:   "tzgate",
	Short: "Unified server tunnel manager",
	Long:  "TzGate manages DNS tunnels (DNSTT, NoizDNS, tz-kitonga, VayDNS) and HTTPS proxies (NaiveProxy) with systemd services.",
