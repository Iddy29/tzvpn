...
// testVerify probes a resolver using the tzgate HMAC challenge-response protocol.
//
...
func RunScanner(resolvers []string, testDomain string, port int, timeoutMs int, concurrency int, querySize int, e2eConfig *E2EConfig, outputFile string, e2eResultsOnly bool) {
	...
	fmt.Println()
	fmt.Println("╔══════════════════════════════════════════════════╗")
	fmt.Println("║              VPN-TZ DNS Scanner                 ║")
	fmt.Println("╚══════════════════════════════════════════════════╝")
	fmt.Println()
	fmt.Printf("  Domain:      %s\n", testDomain)
	fmt.Printf("  Resolvers:   %d\n", total)
