...
const (
	DefaultConfigDir  = "/etc/cybergate"
	DefaultConfigFile = "/etc/cybergate/config.json"
	DefaultTunnelDir  = "/etc/cybergate/tunnels"
	DefaultBinDir     = "/usr/local/bin"
	SystemUser        = "cybergate"
	SystemGroup       = "cybergate"
	SSHGroup          = "cybergate-ssh"
)
...
// Config is the top-level cybergate configuration.
type Config struct {
	mu       sync.RWMutex
	path     string
