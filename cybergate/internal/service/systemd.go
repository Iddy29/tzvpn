...
// ListCybergateServices returns the names of all cybergate-* service files
// found in the systemd directory (without the .service suffix).
func ListCybergateServices() []string {
	...
	for _, e := range entries {
		name := e.Name()
		if strings.HasPrefix(name, "cybergate-") && strings.HasSuffix(name, ".service") {
