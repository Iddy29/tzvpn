#!/usr/bin/env bash
# ============================================================================
#  CyberGate - Hysteria2 server setup
#  Part of the CyberGate server installer (github.com/Iddy29/tzvpn/cybergate)
#
...
echo ""
echo "=========================================="
echo "   CyberGate - Hysteria2 server setup"
echo "=========================================="
echo ""
...
[Unit]
Description=Hysteria2 Server (CyberGate)
...
LINK="hysteria2://${PASSWORD}@${LINK_HOST}:${PORT}/?${QUERY}#CyberGate-Hy2"
...
echo "  Obfs:     $OBFS"
echo ""
echo "  Import this link into the TZVPN app:"
echo ""
