...
# to reach this CyberGate server's DNS-tunneling transports (DNSTT / VayDNS).
#
# Usage:
...
#   - Excludes 127.0.0.0/8 (cybergate-dnsrouter -> local tunnel backends).
...
DEFAULT_LOG="/var/log/cybergate-dns-clients.log"
